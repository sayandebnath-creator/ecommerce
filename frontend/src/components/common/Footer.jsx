  ...
  return (
    ...
    <div className="row mb-5">
      <div className="col-md-3 pb-4">
        ...
        <div className='pt-3 pe-5'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus fugiat est, mollitia sequi cum similique.</div>
      </div>
      <div className="col-md-3 pb-4">
        ...
        <div className='row spotlight py-5'>
          ...
          <h3 className='ps-2'>Money Back Guarentee</h3>
              </div>
            </div>
            <div className="col-md-4">
            <div className="d-flex justify-content-center py-3">
